...
<div>
  ...
  {#if !fieldBody.nA}
    <label for="MaximumDosageAmount">Amount:</label>
    <input
      type="number"
      name="newMaximumDosageAmount"
      bind:value={fieldBody.amount}
    />

    <label for="MaximumDosageUnit">Unit:</label>
    ...
    <br />
    <label for="MaximumDosageFrequency">Frequency:</label>
    <p>
      <input
        type="number"
        name="newMaximumDosageFrequencyTimes"
      ...
      <input
        type="number"
        name="newMaximumDosageFrequencyEvery"
      ...
      <input
        type="number"
        name="newMaximumDosageFrequencyDurationNumber"
